...
<section id="cart_items">
    ...
    <div class="col-md-6 pull-left">
      ...
      <div class="col-md-8 col-lg-10 col-sm-3" style="float:left">
    <?php echo $singlecustomer->STREETADD . ' ' . $singlecustomer->CITYADD . ' ' . $singlecustomer->PROVINCE . ' ' . $singlecustomer->COUNTRY; ?>
</div>
      ...
      <div class="table-responsive cart_info"> 
              ...
              ?>
                         ...
                         <!-- <td></td> -->
                          ...
                          <td>&#8360 <?php echo  $result->PROPRICE ?></td>
                                        ...
                                        <div class="col-md-12">
                                          ...
                                          <div class="col-md-8">
                                           ...
                                           <option value="0" >Select</option>
                                            ...
                                            foreach ($cur as $result) {  
                                              echo '<option value='.$result->DELPRICE.'>'.$result->WARD.' '.$result->PLACE.' </option>';
                                            }
                                            ?>
                                          </select>
                                          </div>
