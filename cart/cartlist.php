    ...
    <div class="col-md-12 col-sm-8 content">  
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default panel-shadow">
                    ...
                    <div class="table-responsive">
                         ...
                         <thead>
                           <tr>
                             <td>
                             <div class="culomn4"><div style="float: left; width:90px">Pet</div></div>
                         ...
                         <body onload=" totalprice(); ">
                            ...
                            <?php  
                                  ...
                                  echo "<h1>You didn't choose any of the pets.</h1>";
                               } 
                            ?>
                              </div> <!--Scrollbar--> 
                ...
                <a href="index.php?page=2" class="btn btn-default pull-left"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;<strong>Add New</strong></a>
