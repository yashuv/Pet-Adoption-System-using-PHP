...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> +977 98########</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i>student@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-md-8 clearfix">
            <div class="shop-menu clearfix pull-right">
              <ul class="nav navbar-nav">     
                <li><a href="<?php echo web_root;?>index.php?q=cart"><i class="fa fa-shopping-cart"></i> View Details</a></li>
          ...
          <div class="col-sm-9">
            ...
            <div class="mainmenu pull-left">
              <ul class="nav navbar-nav collapse navbar-collapse">
                ...
                <li><a href="<?php web_root?>index.php?q=product">Pets</a></li>
                <li><a href="<?php web_root?>index.php?q=service">Service</a></li>
        ...
        <div class="row">
          ...
          <div class="col-sm-3">
            <div class="address">
              ...
              <p>The British College, Kathmandu, Nepal</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Developed by <span>Student</span></p>
        </div>
      </div>
    </div>
...
function validatedate(){ 
    ...
    var onum = document.getElementById('ORDERNUMBER').value
     ...
     if (mytime<todaytime){ 
        ...
        window.location = "index.php?page=7&price="+tprice+"&time="+txtime+"&WARD="+WARD+"&ordernumber="+onum; 
      }
  }
</script>  
