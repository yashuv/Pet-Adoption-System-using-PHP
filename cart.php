<section id="cart_items">
    <div class="container">
      <div class="breadcrumbs">
        <ol class="breadcrumb">
          <li><a href="#">Home</a></li>
          <li class="active">Your Top Picks</li>
        </ol>
      </div>
                          ...
                          <tr class="cart_menu"> 
                             ...
                             <?php
                              ...
                              if (!empty($_SESSION['gcCart'])){ 
                                ...
                                <tr>
                                  <td>  
                                    <img src="<?php echo web_root. 'admin/products/'.$result->IMAGES; ?>"  onload="  totalprice() " width="350px" height="400px"> 
                                  <br/> 
                                        <?php    
